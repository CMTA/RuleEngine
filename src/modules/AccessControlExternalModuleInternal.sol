...
abstract contract AccessControlExternalModuleInternal {
    ...
    */
    function checkTransferAdmin(  bytes32 role, address newAdmin) internal view returns (bool) {
        if(role == 0x0){
            if((_pendingDefaultAdmin == newAdmin) && (_pendingDefaultAdminSchedule == 0)) {
                return true;
            }
            return false;
        }
    ...
    function _acceptDefaultAdminTransfer() internal virtual {
        ...
        /*
        Deactivate since it is not inside this contract where we can grant and revoke role.
        */
        //_revokeRole(DEFAULT_ADMIN_ROLE, defaultAdmin());
        // _grantRole(DEFAULT_ADMIN_ROLE, newAdmin);
        // We need to keep trace of the pending admin
