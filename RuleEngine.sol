...
interface IRulesManagementModule {
    ...
    /**
     * @notice Returns the number of rules currently set for s.
     ...
     */
    function rule(uint256 ruleId) external view returns (address);

    /**
     * @notice Returns the full list of  rules.
     ...
     *
     */
    function containsRule(IRule rule_) external returns (bool);
}
    ...
    IRulesManagementModule
{
    ...
    */
    function removeRule(
        ...
        require(_rules.contains(address(rule_)), RuleEngine_RuleDoNotMatch());
        _removeRule(rule_);
    }
