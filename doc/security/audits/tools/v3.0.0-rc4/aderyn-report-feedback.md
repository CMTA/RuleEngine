...
**Report file:** `doc/security/audits/tools/v3.0.0-rc4/aderyn-report.md`  
...
No High findings were reported. Finding set is unchanged from v3.0.0-rc3.

## Changes since v3.0.0-rc3

Scope grew from 21 files / 607 nSLOC to 24 files / 629 nSLOC (+3 files, +22 nSLOC). The added files are small invariant-storage and roles-storage abstract contracts (`ERC3643ComplianceModuleInvariantStorage`, `ERC3643ComplianceRolesStorage`, `RulesManagementModuleRolesStorage`). None introduce new finding categories.
